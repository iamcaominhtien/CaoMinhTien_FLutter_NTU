...
class SinhVienDetailed extends StatefulWidget {
  const SinhVienDetailed({Key? key, this.svSnapShot, this.xem})
      : super(key: key);
  final SinhVienSnapShot? svSnapShot;
  final bool? xem;

  @override
  State<SinhVienDetailed> createState() => _SinhVienDetailedState();
}

class _SinhVienDetailedState extends State<SinhVienDetailed> {
  ...
  void _update(BuildContext context) async {
    if (svSnapShot != null) {
      ...
      showSnackbar(context, 'Đang thêm dữ liệu', 300);
    }
